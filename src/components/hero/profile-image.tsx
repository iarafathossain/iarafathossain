...
export const ProfileImage = () => {
  return (
    <motion.div
      ...
      className="relative flex items-center justify-center p-4 mb-0 md:mb-8 pointer-events-none"
    >
      {/* Soft Outer Glow */}
      ...
      <div className="relative z-10 w-50 h-50 md:w-80 md:h-80 rounded-full shadow-2xl shadow-primary/20">
        <motion.div
